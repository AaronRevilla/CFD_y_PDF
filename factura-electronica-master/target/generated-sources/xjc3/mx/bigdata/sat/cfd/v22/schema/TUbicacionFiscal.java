    ...
    implements Serializable
{
    ...
    public String toString(){
        String[] componentesUbicacion = {this.getCalle(), this.getNoExterior(), this.getNoInterior(), this.getColonia(), this.getMunicipio(), this.getCodigoPostal(), this.getEstado(), this.getPais()};
        String domicilio =              componentesUbicacion[0] +
                           " No."   +   componentesUbicacion[1] +
                           "-"      +   componentesUbicacion[2] +
                           " Col."  +   componentesUbicacion[3] +
                           ", "     +   componentesUbicacion[4] +
                           " C.P."  +   componentesUbicacion[5] +
                           ", "     +   componentesUbicacion[6] +
                           ", "     +   componentesUbicacion[7] ;
        return domicilio;
    }
}
